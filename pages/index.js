...
export default class extends React.Component { 
  ...
  async requestMccoin() {
      ...
      const response = await axios.get('http://localhost:3001/faucet/9383deb8decad89faec764db2ab881358304b022/10');
      ...
      <div>
        ...
        <div className="container">
          <div className="container" style={{'max-width': '700px', 'margin-top': '150px'}}>
            ...
            <div className="row">
              <div className="col">
                <Input fluid focus disabled={this.state.loading} placeholder='Address' />
              </div>
              <div>
