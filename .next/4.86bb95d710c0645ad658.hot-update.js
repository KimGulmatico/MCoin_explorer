...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      }, "Search")))))), this.state.show == 'blocks' ? allblocks : this.state.show == 'transactions' ? transactions : this.state.show == 'transactionsAdrs' ? transactionsAdrs : transactionsbyhash), this.state.load ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_react_loader_spinner___default.a, {
        style: {
          position: 'absolute',
          'top': '50% !important'
        },
...
//# sourceMappingURL=4.86bb95d710c0645ad658.hot-update.js.map