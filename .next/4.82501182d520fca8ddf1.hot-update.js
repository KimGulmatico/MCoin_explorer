...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function search() {
      if (!isNaN(this.state.search) && this.state.search != '' && this.state.search.length != 40) {
    ...
    value: function render() {
      ...
      }, "Transactions"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_semantic_ui_react__["e" /* Table */], {
        celled: true,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 210
...
//# sourceMappingURL=4.82501182d520fca8ddf1.hot-update.js.map