...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    key: "requestMccoin",
    value: function requestMccoin() {
      this.setState({
        loading: true
      });
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('http://localhost:3001/faucet/9383deb8decad89faec764db2ab881358304b022/10').then(function (response) {
        this.setState({
          loading: true
        });
    ...
    value: function render() {
      ...
      }, "Mccoin Faucet"))))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "col-2",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 67
      ...
      }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["b" /* Input */], {
        fluid: true,
        focus: true,
        placeholder: "Address",
        __source: {
...
//# sourceMappingURL=4.bc79688266ba2e028a06.hot-update.js.map